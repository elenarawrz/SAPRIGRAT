	...
	private ValueChangeListener llenarTablaListener =   new ValueChangeListener()
														{
															...
															public void valueChange(ValueChangeEvent event)
															{
																...
																//Obtener la lista
																LinkedList<Object[]> resultados = datos.getTecnicos(new Object[]{((String)cmbResponsable.getValue()).split(" ")[0], tipoPersona});
	...
	private ItemClickListener llenarFormListener =  new ItemClickListener()
													{
														...
														public void itemClick(ItemClickEvent event)
														{
															...
															{
																String curr = tblListado.getItemCaption(event.getItem()).split(" ")[0];
																LinkedList<Object> valores = datos.getTecnico(curr);
																if(!valores.isEmpty())
																{
																	txtCURR.setValue(curr);
																	cmbResponsable.addItem(valores.peek());

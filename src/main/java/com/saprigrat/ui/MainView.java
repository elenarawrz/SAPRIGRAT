...
import com.saprigrat.ui.forms.reportes.Resultados;
...
public class MainView extends CustomComponent
{
	...
	{
		MenuItem menuNiv = mbrMenu.addItem("Niveles de Administración", null);
		mbrMenu.addItem("Parcelas", com(new Parcela(usuario)));
		MenuItem menuRes = mbrMenu.addItem("Resultados", null);
		
		if(usuario.getTipo() == usuario.ADMINISTRADOR_GENERAL)
		{
			menuNiv.addItem("Administrador General", com(new Administrador(usuario.ADMINISTRADOR_GENERAL, usuario)));
			menuNiv.addItem("Administrador de Distrito", com(new Administrador(usuario.ADMINISTRADOR, usuario)));
		}
		if(usuario.getTipo() <= usuario.ADMINISTRADOR)
		{
			menuNiv.addItem("Supervisor Técnico", com(new Tecnico(usuario.SUPERVISOR, usuario, TipoUsuario.SUPERVISOR_TECNICO)));
			menuRes.addItem("Organismo de Cuenca", com(new Resultados(TipoResultado.ORGANISMO_CUENCA, usuario)));
			menuRes.addItem("Distrito de Riego", com(new Resultados(TipoResultado.DISTRITO_RIEGO, usuario)));
			menuRes.addItem("Módulo de Riego", com(new Resultados(TipoResultado.MODULO_RIEGO, usuario)));
		}
		if(usuario.getTipo() <= usuario.SUPERVISOR)
		{
			menuNiv.addItem("Responsable Técnico", com(new Tecnico(usuario.RESPONSABLE, usuario, TipoUsuario.RESPONSABLE_TECNICO)));
			menuRes.addItem("Supervisor Técnico", com(new Resultados(TipoResultado.SUPERVISOR_TECNICO, usuario)));
		}
		menuNiv.addItem("Usuario", com(new Productor(usuario)));
		menuRes.addItem("Responsable Técnico", com(new Resultados(TipoResultado.RESPONSABLE_TECNICO, usuario)));

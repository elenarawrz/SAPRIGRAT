package com.saprigrat.ui.forms.riegos;
...
//		tblRiegos.setRowHeaderMode(Table.RowHeaderMode.INDEX);
	...
	private AbsoluteLayout buildAbsLDetalles() {
		...
		cmbTipoRiego.setWidth("110px");
		cmbTipoRiego.setHeight("25px");
		absLDetalles.addComponent(cmbTipoRiego, "top:28.0px;left:320.0px;");
	...
	private VerticalLayout buildVerLRiegos() {
		...
		verLRiegos.setWidth("601px");
		verLRiegos.setHeight("-1px");
		verLRiegos.setMargin(false);
		
		// horLBotonesRiego
		horLBotonesRiego = buildHorLBotonesRiego();
		verLRiegos.addComponent(horLBotonesRiego);
		verLRiegos.setComponentAlignment(horLBotonesRiego, new Alignment(10));
		
		// panRiego
		panRiego = buildPanRiego();
		verLRiegos.addComponent(panRiego);
	...
	private HorizontalLayout buildHorLBotonesRiego() {
		...
		horLBotonesRiego.addComponent(btnCancelar);
	...
	private AbsoluteLayout buildAbsLRiego1() {
		...
		txtEtapa.setWidth("280px");
		txtEtapa.setHeight("25px");
		absLRiego1.addComponent(txtEtapa, "top:28.0px;left:130.0px;");

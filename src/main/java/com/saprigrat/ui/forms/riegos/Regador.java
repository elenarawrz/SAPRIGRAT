														...
														public void itemClick(ItemClickEvent event)
														{
															if(event.isDoubleClick())
															{
																...
																if(!valores.isEmpty())
																{
																	...
																	datIngreso.setValue(setFecha((Date)valores.remove()));
...
//		inicializar();
	...
	private AbsoluteLayout buildAbsLGenerales2() {
		...
		absLGenerales2.addComponent(txtApM, "top:18.0px;left:170.0px;");

...
public class Tecnico extends CustomComponent implements Formulario
{
	...
	private boolean validar()
	{
		...
		if(datNacimiento.getValue() == null)
			return u.notificar("Se requiere especificar la fecha de nacimiento", datNacimiento, u.MSJ_ERROR);
		...
		if(txtLoc.getValue().isEmpty())
			return u.notificar("Se requiere especificar la localidad", txtLoc, u.MSJ_ERROR);
		if(txtCalle.getValue().isEmpty())
			return u.notificar("Se requiere especificar la calle", txtCalle, u.MSJ_ERROR);
		if(txtNoExt.getValue().isEmpty())
			return u.notificar("Se requiere especificar el número exterior", txtNoExt, u.MSJ_ERROR);
	...
	private AbsoluteLayout buildAbsLCredenciales2() {
		...
		cmbInstitucionAcredita.setWidth("260px");
		...
		txtAcreditacion.setWidth("220px");
		txtAcreditacion.setHeight("25px");
		absLCredenciales2.addComponent(txtAcreditacion,
				"top:18.0px;left:290.0px;");

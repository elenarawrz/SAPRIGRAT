...
public class Tecnico extends CustomComponent implements Formulario
{
	...
	@AutoGenerated
	private AbsoluteLayout absLCredenciales5;
	@AutoGenerated
	private AbsoluteLayout absLCredenciales4;
	@AutoGenerated
	private Label lblSuperficieProgramada;
	@AutoGenerated
	private TextField txtSuperficieProgramada;
	@AutoGenerated
				...
				public void itemClick(ItemClickEvent event)
				{
					if(event.isDoubleClick())
					{
						...
						if(!valores.isEmpty())
						{
							...
							txtSuperficieProgramada.setValue(u.doubleToString(valores.remove()));
							valores.remove();//TODO
	...
	public void inicializar()
	{
		...
		if(tipoPersona == usuario.RESPONSABLE)
			absLCredencialesUser.setHeight("203px");
		else
			absLCredenciales4.setVisible(false);
	...
	private LinkedList<Object> llenarListaDeParametros()
	{
		...
		valores.add(u.stringToDouble(txtSuperficieProgramada.getValue()));
		valores.add("");//TODO
	...
	private VerticalLayout buildVerLCredenciales() {
		...
		// absLCredenciales4
		absLCredenciales4 = buildAbsLCredenciales4();
		verLCredenciales.addComponent(absLCredenciales4);
		
		// absLCredenciales5
		absLCredenciales5 = new AbsoluteLayout();
		absLCredenciales5.setImmediate(false);
		absLCredenciales5.setWidth("100.0%");
		absLCredenciales5.setHeight("10px");
		verLCredenciales.addComponent(absLCredenciales5);
	...
	private AbsoluteLayout buildAbsLCredenciales3() {
		...
		absLCredenciales3.setHeight("45px");
	...
	@AutoGenerated
	private AbsoluteLayout buildAbsLCredenciales4() {
		// common part: create layout
		absLCredenciales4 = new AbsoluteLayout();
		absLCredenciales4.setImmediate(false);
		absLCredenciales4.setWidth("100.0%");
		absLCredenciales4.setHeight("45px");
		
		// txtSuperficieProgramada
		txtSuperficieProgramada = new TextField();
		txtSuperficieProgramada.setCaption("Superficie Programada");
		txtSuperficieProgramada.setImmediate(false);
		txtSuperficieProgramada.setWidth("150px");
		txtSuperficieProgramada.setHeight("25px");
		absLCredenciales4.addComponent(txtSuperficieProgramada,
				"top:18.0px;left:10.0px;");
		
		// lblSuperficieProgramada
		lblSuperficieProgramada = new Label();
		lblSuperficieProgramada.setImmediate(false);
		lblSuperficieProgramada.setWidth("-1px");
		lblSuperficieProgramada.setHeight("-1px");
		lblSuperficieProgramada.setValue("ha");
		absLCredenciales4.addComponent(lblSuperficieProgramada,
				"top:22.0px;left:165.0px;");
		
		return absLCredenciales4;
	}

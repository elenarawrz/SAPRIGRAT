														...
														public void itemClick(ItemClickEvent event)
														{
															if(event.isDoubleClick())
															{
																...
																if(!valores.isEmpty())
																{
																	...
																	datNivelacion.setValue(setFecha((Date)valores.remove()));
																	...
																	datSiembra.setValue(setFecha((Date)valores.remove()));
																	datCosecha.setValue(setFecha((Date)valores.remove()));
																	cmbCicloAnt.setValue(valores.remove());
																	txtCultivoAnt.setValue((String)valores.remove());
																	txtRendimientoAnt.setValue(valores.remove() + "");
																	datSiembraAnt.setValue(setFecha((Date)valores.remove()));
																	datCosechaAnt.setValue(setFecha((Date)valores.remove()));
																}
																else

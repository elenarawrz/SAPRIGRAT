...
public class Riego extends CustomComponent implements Formulario, FormParcela
{
	...
	@AutoGenerated
	private Label lblLaminaAntCalc;
	@AutoGenerated
	private TextField txtLaminaAntCalc;
	@AutoGenerated
				...
				public void itemClick(ItemClickEvent event)
				{
					if(event.isDoubleClick())
					{
						...
						if(!valores.isEmpty())
						{
							...
							txtLaminaAntCalc.setValue(u.doubleToString(valores.remove()));
	...
	public void quitarListeners ()
	{
		...
		absLDetalles.removeComponent(txtLaminaAntCalc);
		absLDetalles.removeComponent(lblLaminaAntCalc);
		...
		absLDetalles.addComponent(lblLaminaAnt, "top:32.0px;left:375.0px;");
		absLDetalles.addComponent(txtLaminaAntCalc, "top:28.0px;left:410.0px;");
		absLDetalles.addComponent(lblLaminaAntCalc, "top:32.0px;left:585.0px;");
		panDetalles.setWidth("611px");
	}
	...
	private void setValidaciones()
	{
		...
		txtLaminaAntCalc.addValidator(esDecimal);
	...
	private boolean validar()
	{
		...
		if(!txtLaminaAnt.isValid())
			return u.notificar("Se requiere especificar un valor estríctamente numérico para la lámina aplicada el ciclo anterior", txtLaminaAnt, u.MSJ_ERROR);
		
		if(!txtLaminaAntCalc.isValid())
			return u.notificar("Se requiere especificar un valor estríctamente numérico para la lámina calculada el ciclo anterior", txtLaminaAntCalc, u.MSJ_ERROR);
	...
	private LinkedList<Object> llenarListaDeParametros()
	{
		...
		valores.add(u.stringToDouble(txtLaminaAntCalc.getValue()));
	...
	private AbsoluteLayout buildAbsLDetalles() {
		...
		txtLaminaAnt.setCaption("Lámina Aplicada el Ciclo Anterior");
		txtLaminaAnt.setImmediate(true);
		txtLaminaAnt.setWidth("160px");
		...
		lblLaminaAnt.setValue("cm");
		absLDetalles.addComponent(lblLaminaAnt, "top:32.0px;left:795.0px;");
		
		// txtLaminaAntCalc
		txtLaminaAntCalc = new TextField();
		txtLaminaAntCalc.setCaption("Lámina Calculada el Ciclo Anterior");
		txtLaminaAntCalc.setImmediate(true);
		txtLaminaAntCalc.setWidth("170px");
		txtLaminaAntCalc.setHeight("25px");
		absLDetalles.addComponent(txtLaminaAntCalc, "top:28.0px;left:830.0px;");
		
		// lblLaminaAntCalc
		lblLaminaAntCalc = new Label();
		lblLaminaAntCalc.setImmediate(false);
		lblLaminaAntCalc.setWidth("-1px");
		lblLaminaAntCalc.setHeight("-1px");
		lblLaminaAntCalc.setValue("cm");
		absLDetalles.addComponent(lblLaminaAntCalc, "top:32.0px;left:1005.0px;");
	...
	private AbsoluteLayout buildAbsLRiego2() {
		...
		txtLaminaCalc.setCaption("Lámina Calculada");

...
public class CaracterizacionParcela extends CustomComponent implements Formulario
{
	...
	private ItemClickListener llenarFormListener = new ItemClickListener()
			{
				...
				public void itemClick(ItemClickEvent event)
				{
					...
					{
						idCaracterizacionParcela = Integer.parseInt(tblListado.getItemCaption(event.getItem()).split(" ")[0]);
	...
	private ValueChangeListener llenarTablaListener = new ValueChangeListener()
			{
				...
				{
					u.llenarTabla(tblListado, datos.getCaracterizaciones(((String)cmbResponsable.getValue()).split(" ")[0]));
				}
			};
	...
	private ValueChangeListener llenarParcelasListener = new ValueChangeListener()
			{
				...
				public void valueChange(ValueChangeEvent event)
				{
					...
					if(cmbParcela.size() == 0)
						Notification.show("No se podrá agregar el registro ya que este productor no tiene asociada ninguna parcela.", Notification.Type.ERROR_MESSAGE);
				}
			};
	private ValueChangeListener fueNiveladaListener = new ValueChangeListener()
			{
				...
				public void valueChange(ValueChangeEvent event)
				{
					datNivelacion.setVisible(chkNivelada.getValue());
				}
			};
	...
	public CaracterizacionParcela(Usuario user)
	{
		usuario = user;
		u = new Utilerias();
		datos = new Datos();
	...
	public void inicializar()
	{
		...
		u.setupCombo(cmbTipoSuelo, datos.getTipoSuelo(), null, null, false);
		u.setupCombo(cmbCiclo, ciclos, null, null, false);
		u.setupCombo(cmbCicloAnt, ciclos, null, null, false);
		cmbProductor.addValueChangeListener(llenarParcelasListener);
		//Datefields
	...
	private boolean validar()
	{
		...
		if(cmbProductor.getValue() == null)
			return notificar("Se requiere especificar el usuario", cmbProductor);
		if(cmbParcela.getValue() == null)
			return notificar("Se requiere especificar la parcela", cmbParcela);
	...
	private HorizontalLayout buildHorLGralesNivelacion() {
		...
		horLGralesNivelacion.setWidth("801px");
	...
	private AbsoluteLayout buildAbsLGenerales1() {
		...
		cmbParcela.setCaption("Parcela (No. de Cta. / Subcta.)");
		cmbParcela.setImmediate(false);
		cmbParcela.setWidth("330px");
		cmbParcela.setHeight("25px");
		cmbParcela.setTabIndex(2);
		absLGenerales1.addComponent(cmbParcela, "top:28.0px;left:10.0px;");
		...
		absLGenerales1.addComponent(chkTrazo, "top:28.0px;left:360.0px;");
	...
	private AbsoluteLayout buildAbsLNivelacion() {
		...
		datNivelacion.setWidth("130px");
		datNivelacion.setHeight("25px");
		datNivelacion.setTabIndex(4);
		absLNivelacion.addComponent(datNivelacion, "top:10.0px;left:140.0px;");
	...
	private AbsoluteLayout buildAbsLCultivoAct() {
		...
		absLCultivoAct
				.addComponent(lblRendimiento, "top:122.0px;left:190.0px;");

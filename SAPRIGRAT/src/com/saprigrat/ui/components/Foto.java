...
public class Foto extends CustomComponent
{
	...
	@AutoGenerated
	private VerticalLayout verLFoto;
	@AutoGenerated
	...
	private AbsoluteLayout buildAbsLFoto() {
		...
		// verLFoto
		verLFoto = buildVerLFoto();
		absLFoto.addComponent(verLFoto, "top:10.0px;left:10.0px;");
	...
	@AutoGenerated
	private VerticalLayout buildVerLFoto() {
		// common part: create layout
		...
		verLFoto.addComponent(imgFoto);
		verLFoto.setComponentAlignment(imgFoto, new Alignment(48));

...
public class LecturaInicial extends CustomComponent
{
	...
	private VerticalLayout buildMainLayout() {
		...
		mainLayout.setComponentAlignment(panConsumo, new Alignment(48));
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		horizontalLayout_1.addComponent(panFecPrueba);
		horizontalLayout_1.setComponentAlignment(panFecPrueba,
				new Alignment(48));
		
		// panLectFlujo
		panLectFlujo = buildPanLectFlujo();
		horizontalLayout_1.addComponent(panLectFlujo);
		horizontalLayout_1.setComponentAlignment(panLectFlujo,
				new Alignment(48));
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		horizontalLayout_2.addComponent(panFecCFE);
		horizontalLayout_2.setComponentAlignment(panFecCFE, new Alignment(48));
		
		// panLectCFE
		panLectCFE = buildPanLectCFE();
		horizontalLayout_2.addComponent(panLectCFE);
		horizontalLayout_2.setComponentAlignment(panLectCFE, new Alignment(48));
	...
	private AbsoluteLayout buildAbsLConsumo() {
		...
		absLConsumo.addComponent(lblConsumo, "top:77.0px;left:145.0px;");
		...
		absLConsumo.addComponent(txtTiempo, "top:28.0px;left:180.0px;");
		...
		absLConsumo.addComponent(lblTiempo, "top:32.0px;left:315.0px;");
		
		// txtConsumoReal
		txtConsumoReal = new TextField();
		txtConsumoReal.setCaption("Consumo Real");
		txtConsumoReal.setImmediate(false);
		txtConsumoReal.setWidth("130px");
		txtConsumoReal.setHeight("25px");
		absLConsumo.addComponent(txtConsumoReal, "top:73.0px;left:180.0px;");
		...
		absLConsumo.addComponent(lblConsumoReal, "top:77.0px;left:315.0px;");

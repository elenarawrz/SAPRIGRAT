...
/*	private void setMenu()
	{
		addMenu("Supervisor", new SupervisorInfo());
		addMenu("Supervisor Técnico", new TecnicoInfo());
		addMenu("Usuario/Productor", new UsuarioInfo());
		addMenu("Parcela", new ParcelaInfo());

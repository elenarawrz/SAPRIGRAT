...
import com.saprigrat.data.InterfazConsulta;
...
public class Persona extends CustomComponent implements Formulario
{
	...
	public Persona(int tipoPersona)
	{
		...
		LinkedList<String>edos = new InterfazConsulta().getEstados();
		while(!edos.isEmpty())
		...
		cmbEdo.addValueChangeListener(  new ValueChangeListener()
										{
											...
											public void valueChange(ValueChangeEvent event)
											{
												...
												LinkedList<String>mpios = new InterfazConsulta().getMunicipios(cmbEdo.getValue() + "");
		...
		btnSel.addClickListener( new ClickListener()
									{
										@Override
...
//		txtCURR.addValidator(validarRegEx());
		...
		txtCP.addValidator(new IntegerRangeValidator("Debe ser un número entero", 0, 99999));
...
//		txtInstitucion.setMaxLength();
	...
	public void setTipo(int tipoOperacion)
	{
		...
		{
			cmbParametro.addItem("CURR");
			cmbParametro.addItem("Nombre");
			cmbParametro.select("CURR");

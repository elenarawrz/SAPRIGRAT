...
//			panCURR.setVisible(true);
	...
	private AbsoluteLayout buildAbsLGenerales() {
		...
		cmbTecnico.setWidth("280px");
		cmbTecnico.setHeight("-1px");
		absLGenerales.addComponent(cmbTecnico, "top:28.0px;left:310.0px;");
		
		// cmbModulo
		cmbModulo = new ComboBox();
		cmbModulo.setCaption("Módulo");
		cmbModulo.setImmediate(false);
		cmbModulo.setWidth("280px");
		cmbModulo.setHeight("-1px");
		absLGenerales.addComponent(cmbModulo, "top:73.0px;left:10.0px;");
	...
	private AbsoluteLayout buildAbsLCaracteristicas() {
		...
		absLCaracteristicas.setHeight("290px");
		...
		absLCaracteristicas
				.addComponent(txtLongitud, "top:73.0px;left:10.0px;");
		...
		absLCaracteristicas.addComponent(txtAncho, "top:118.0px;left:10.0px;");
		...
		lblAncho.setValue("m");
		absLCaracteristicas.addComponent(lblAncho, "top:122.0px;left:160.0px;");
		...
		absLCaracteristicas.addComponent(txtHumSat, "top:73.0px;left:195.0px;");
		...
		absLCaracteristicas.addComponent(lblHumSat, "top:77.0px;left:345.0px;");
		...
		absLCaracteristicas.addComponent(txtHumCC, "top:118.0px;left:195.0px;");
		...
		absLCaracteristicas.addComponent(lblHumCC, "top:122.0px;left:345.0px;");
		...
		absLCaracteristicas
				.addComponent(txtHumPMP, "top:163.0px;left:195.0px;");
		...
		absLCaracteristicas
				.addComponent(lblHumPMP, "top:167.0px;left:345.0px;");
		...
		absLCaracteristicas.addComponent(txtArena, "top:163.0px;left:410.0px;");
		...
		lblArena.setValue("%");
		absLCaracteristicas.addComponent(lblArena, "top:167.0px;left:560.0px;");
		...
		absLCaracteristicas.addComponent(txtLimo, "top:253.0px;left:410.0px;");
		...
		lblLimo.setValue("%");
		absLCaracteristicas.addComponent(lblLimo, "top:257.0px;left:560.0px;");
		...
		absLCaracteristicas.addComponent(txtTipoSuelo,

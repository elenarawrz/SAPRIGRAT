...
public class Tecnico extends CustomComponent implements Formulario
{
	...
	public void inicializar()
	{
		...
		setResponsableDirecto(usuario.getTipo(), tipoPersona);
	...
	private void setResponsableDirecto(int tipoAgregando, int tipoAgregar)
	{
		if(tipoAgregando == tipoAgregar - 1)
		{
			cmbResponsable.select(cmbResponsable.addItem(usuario.getCURR() + " " +
														 usuario.getNombre() + " " +
		...
		if(tipoAgregar != 4)
		{
			lista = datos.getTecnicos(usuario.getEstado());
			for(String tecnico : lista) cmbEdo.addItem(tecnico);
		}
		else
		{
			lista = datos.getProductores(usuario.getEstado());
			for(String productor : lista) cmbEdo.addItem(productor);
		}
	}
		...
		return  new ClickListener()
				{
					...
					public void buttonClick(ClickEvent event)
					{
						...
						if(datos.modificar("tecnicos", valores))

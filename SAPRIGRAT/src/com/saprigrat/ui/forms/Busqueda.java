...
public class Busqueda extends CustomComponent
{
	...
	public Busqueda(String[]opciones)
	{
		buildMainLayout();
		...
		txtBusqueda.addTextChangeListener(textListener(opciones));
		...
		if(StringUtils.join(opciones, ",").indexOf("Nombre") != -1)
		{
	...
	private TextChangeListener textListener(final String[]opciones)
	{
		return new TextChangeListener()
				{
					...
					public void textChange(TextChangeEvent event)
					{
						...
						LinkedList<String[]> resultados = new InterfazConsulta().getBusqueda(StringUtils.join(opciones, ","),

...
public class SupervisorInfo extends CustomComponent implements Formulario
{
	@AutoGenerated
	...
	public SupervisorInfo()
	{
		...
		stpTecnicos.setInvalidAllowed(false);
...
//		txtInstitucion.setMaxLength();
		...
		txtSupAtendida.setMaxLength(8);
		txtSupAtendida.addValidator(validarDouble(0, 99999.99));
//		txtUdeRAtendidas.setMaxLength();
		
	}
	
	private Validator validarInt(int min, int max)
	{
		return new IntegerRangeValidator("Debe ser un número entero",
										 min, max);
	}
	
	private Validator validarDouble(double min, double max)
	{
		return new DoubleRangeValidator("Debe ser un número decimal",
										min, max);
	}
	...
	private AbsoluteLayout buildAbsLDetTecnicos1() {
		...
		stpTecnicos.setImmediate(true);
		stpTecnicos.setWidth("120px");
		stpTecnicos.setHeight("25px");
		absLDetTecnicos1.addComponent(stpTecnicos, "top:28.0px;left:470.0px;");
